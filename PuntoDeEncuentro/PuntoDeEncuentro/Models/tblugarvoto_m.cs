...
namespace PuntoDeEncuentro.Models
{
    ...
    {
        [Display(Name = "Tu idvoto")]//nombre de los labels
        ...
        [Display(Name = "El numero de votos")]//nombre de los labels
        [DataType(DataType.Text, ErrorMessage = "Intentelo nuevamente!!!")]//tipo de
        [DisplayColumn("campo de nombre", "Nom.")]//nombre en la columna
        [Editable(false)]//no se puede editar
        [Range(1, 100000, ErrorMessage = "Intentelo de nuevo")]
        [ScaffoldColumn(false)]
        object num_votes { get; set; }

        [Display(Name = "El total del score")]//nombre de los labels
        [DataType(DataType.Text, ErrorMessage = "Intentelo nuevamente!!!")]//tipo de
        [DisplayColumn("campo de nombre", "Nom.")]//nombre en la columna
        [Editable(false)]//no se puede editar
        [Range(1, 100000, ErrorMessage = "Intentelo de nuevo")]
        [ScaffoldColumn(false)]
        object tot_score { get; set; }char

        [Display(Name = "El rating")]//nombre de los labels
        [DataType(DataType.Text, ErrorMessage = "Intentelo nuevamente!!!")]//tipo de
        [DisplayColumn("campo de nombre", "Nom.")]//nombre en la columna
        [Editable(false)]//no se puede editar
        [Range(1, 10, ErrorMessage = "Intentelo de nuevo")]
        [ScaffoldColumn(false)]
        object rating { get; set; }

        [Display(Name = "id del lugar")]//nombre de los labels
        [DataType(DataType.Text, ErrorMessage = "Intentelo nuevamente!!!")]//tipo de
        [DisplayColumn("campo de nombre", "Nom.")]//nombre en la columna
        [Editable(false)]//no se puede editar
        [Range(8, 12, ErrorMessage = "Intentelo de nuevo")]
